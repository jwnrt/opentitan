...
EARLGREY_1_0_0_STD_OTP_OVERLAYS_WITHOUT_SECRET_PARTITIONS = EARLGREY_1_0_0_OTP_SIGVERIFY_FAKE_KEYS + [
...
# This is a set of overlays to generate a generic, standard OTP image.
# Additional overlays can be applied on top to further customize the OTP.
EARLGREY_1_0_0_STD_OTP_OVERLAYS = EARLGREY_1_0_0_STD_OTP_OVERLAYS_WITHOUT_SECRET_PARTITIONS + [
